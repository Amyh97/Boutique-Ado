...
ALLOWED_HOSTS = ['boutique-ado-amy.herokuapp.com', 'localhost']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'bag.contexts.bag_contents',  # makes avilible across whole site
            ],
            'builtins': [
...
LOGIN_REDIRECT_URL = '/'  # URL to redirect to on a scuuessful login, temporarily redirect to /success to test.
...
# if deployed use prostgres, else use default setting
...
if 'USE_AWS' in os.environ:
    # Cache control - tells browser its ok to cache for a long time
    AWS_S3_OBJECT_PARAMETERS = {
        'Expires': 'Thu, 31 Dec 2099 20:00:000 GMT',
        'CacheControl' : 'max-age=94608000',
    }
    # Bucket config
    AWS_STORAGE_BUCKET_NAME = 'boutique-ado-amy'
